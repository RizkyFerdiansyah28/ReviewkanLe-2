...
<div class="container">
    ...
    <form action="" method="post" class="mt-5">
        ...
        <div class="mb-3">
            ...
            <textarea class="form-control" id="ulasan" name="ulasan" rows="4" placeholder="Tambahkan ulasan" required></textarea>
        </div>
        ...
        <button type="submit" name="tambah" id="tambah" class="btn btn-success" style="float: right">Kirim Ulasan</button>
    </form>
</div>
